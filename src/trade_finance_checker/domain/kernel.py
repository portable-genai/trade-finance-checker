...
class LlmRequest:
    ...
    #: ``None`` sends no temperature at all (the model's own sampling); a float pins it. Pin
    #: 0.0 only where the output is extracted, classified, scored or compared; leave drafting
    #: and narration free. Free means ABSENT, never 1.0: some models reject the parameter.
