...
class HealthResponse(BaseModel):
    ...
    #: What the UI's model pill states before any answer: where the runtime sits and which
    #: model the bound generator calls. Derived server-side so the console never guesses.
